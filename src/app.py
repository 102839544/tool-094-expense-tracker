...
class App:
    ...
    def setup_ui(self):
        ...
        tk.Label(title_frame, text="📦 记账工具", font=("Arial", 18, "bold"),
        ...
        # 根据工具名称添加特定功能
        if "timer" in "expense-tracker".lower() or "clock" in "expense-tracker".lower():
            self.setup_timer_ui(main)
        elif "random" in "expense-tracker".lower() or "dice" in "expense-tracker".lower() or "coin" in "expense-tracker".lower():
            self.setup_random_ui(main)
        elif "note" in "expense-tracker".lower() or "todo" in "expense-tracker".lower():
    ...
    def generate_random(self):
        if "dice" in "expense-tracker".lower():
            result = random.randint(1, 6)
            self.result_label.config(text=f"🎲 {result}")
        elif "coin" in "expense-tracker".lower():
